...
public class Tiles {
	...
	private Image imgSuperiorDireito;
	private Image imgMeioCima;
	private Image imgMeioBaixo;
	private Image imgInferiorEsquerdo;
	private Image imgInferiorDireito;
	...
	private void carregaImagemTile() {
		...
		// Imagens do inventario
		this.imgSuperiorEsquerdo = loadImage("res_cenario/tiles/Inventario/cantoEsquerdo.png");
		this.imgSuperiorDireito = loadImage("res_cenario/tiles/Inventario/cantoDireito.png");
		this.imgMeioCima = loadImage("res_cenario/tiles/Inventario/meio.png");
		this.imgMeioBaixo = loadImage("res_cenario/tiles/Inventario/meioAbaixo.png");
		this.imgInferiorEsquerdo = loadImage("res_cenario/tiles/Inventario/cantoEsquerdoBaixo.png");
		this.imgInferiorDireito = loadImage("res_cenario/tiles/Inventario/cantoDireitoBaixo.png");
	}
	...
	public void carregaPecaDaMatriz(int valorDaPeca) {
		...
		// tile 59: imgSuperiorDireito
		if (valorDaPeca == 59) {
			this.imgAtual = this.imgSuperiorDireito;
			this.colisao = false;
		}

		// tile 60: imgInferiorDireito
		if (valorDaPeca == 60) {
			this.imgAtual = this.imgInferiorDireito;
			this.colisao = false;
		}

		// tile 61: SuperiorEsquerdo
		if (valorDaPeca == 61) {
			this.imgAtual = this.imgSuperiorEsquerdo;
			this.colisao = false;
		}

		// tile 62: imgInferiorEsquerdo
		if (valorDaPeca == 62) {
			this.imgAtual = this.imgInferiorEsquerdo;
			this.colisao = false;
		}

		// tile 63: imgMeioCima
		if (valorDaPeca == 63) {
			this.imgAtual = this.imgMeioCima;
			this.colisao = false;
		}

		// tile 64: imgMeiobaixo
		if (valorDaPeca == 64) {
