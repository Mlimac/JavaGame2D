...
public class tileMap {
    ...
    int[][] cenario1DoJogo = {
            ...
            { 19, 17, 17, 17, 17, 19, 2, 2, 2, 2, 19, 17, 17, 17, 58, 19 },
            { 19, 17, 17, 17, 17, 17, 19, 51, 51, 19, 17, 17, 17, 17, 17, 19 },
            { 19, 17, 58, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 19 },
            { 19, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 19 },
            { 19, 17, 17, 18, 17, 17, 17, 17, 58, 17, 17, 17, 18, 17, 17, 19 },
            { 19, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 19 },
    ...
    int[][] cenario2DoJogo = {
            ...
            { 17, 58, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 58, 17, 19 },
            { 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 19 },
            { 19, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 19 },
            { 19, 17, 17, 17, 17, 17, 19, 19, 19, 19, 17, 17, 17, 17, 17, 19 },
            { 19, 17, 17, 17, 17, 19, 2, 2, 2, 2, 19, 17, 17, 17, 17, 19 },
            { 19, 17, 58, 17, 17, 19, 2, 2, 2, 2, 19, 17, 17, 58, 17, 19 },
            { 19, 17, 17, 17, 5, 19, 2, 2, 2, 2, 19, 17, 17, 17, 17, 19 },
    ...
    int[][] cenario3DoJogo = {
            ...
            { 40, 9, 58, 9, 9, 9, 9, 1, 11, 11, 11, 10, 11, 11, 11, 11 },
            { 40, 9, 9, 9, 9, 9, 9, 1, 11, 58, 11, 10, 11, 32, 11, 11 },
            { 40, 9, 9, 9, 9, 9, 9, 1, 11, 11, 11, 10, 11, 31, 11, 43 },
            { 40, 9, 9, 9, 58, 9, 9, 1, 11, 11, 11, 10, 11, 11, 11, 43 },
            { 40, 9, 9, 9, 9, 9, 9, 1, 11, 11, 11, 10, 11, 11, 11, 43 },
            { 40, 9, 9, 9, 9, 9, 9, 1, 11, 11, 58, 10, 11, 11, 11, 43 },
            { 40, 9, 9, 9, 9, 9, 9, 1, 11, 11, 11, 10, 11, 11, 11, 43 },
    ...
    int[][] cenario4DoJogo = {
            ...
            { 12, 45, 58, 45, 45, 45, 45, 45, 45, 45, 45, 45, 3, 3, 3, 12 },
            { 12, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 3, 45, 45, 12 },
            { 48, 45, 45, 45, 45, 45, 45, 45, 58, 45, 45, 45, 3, 45, 45, 12 },
            { 12, 45, 45, 45, 5, 45, 45, 45, 45, 45, 45, 45, 3, 45, 45, 12 },
            { 12, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 3, 3, 3, 12 },
            { 48, 45, 45, 45, 45, 45, 58, 45, 45, 45, 45, 45, 45, 45, 45, 12 },
            { 12, 45, 45, 45, 45, 45, 45, 45, 45, 45, 58, 45, 45, 45, 45, 12 },
            { 12, 12, 47, 12, 12, 47, 12, 12, 47, 12, 12, 47, 66, 65, 47, 12 },
    };

    int[][] cenario5DoJogo = {
            { 12, 12, 46, 12, 12, 46, 12, 12, 46, 12, 12, 46, 54, 54, 54, 12 },
            { 12, 54, 54, 54, 58, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 12 },
            { 48, 54, 54, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12 },
            { 12, 54, 54, 54, 54, 54, 54, 54, 58, 54, 54, 54, 54, 54, 54, 12 },
            { 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 57, 54, 12 },
            { 12, 54, 54, 58, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 12 },
            { 48, 54, 54, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 46, 12 },
            { 12, 54, 54, 54, 54, 54, 54, 54, 54, 54, 58, 54, 54, 54, 54, 7 },
            { 12, 57, 54, 54, 5, 54, 54, 54, 54, 54, 54, 54, 54, 54, 54, 7 },
    ...
    int[][] cenario6DoJogo = {
            ...
            { 0, 12, 55, 55, 58, 55, 55, 55, 55, 55, 55, 55, 55, 55, 12, 0 },
            ...
            { 55, 55, 58, 55, 55, 55, 56, 56, 56, 55, 55, 55, 3, 3, 3, 12 },
            { 55, 55, 55, 55, 55, 55, 55, 55, 55, 55, 58, 55, 55, 55, 55, 12 },
            { 12, 12, 47, 12, 47, 12, 47, 12, 47, 12, 47, 12, 47, 12, 12, 12 },

    };

    int[][] cenarioDoInventario = {
            { 61, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 59 },
            { 62, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 60 },
    };
    ...
    public void tileInvent() {
        this.cenarioValido = this.cenarioDoInventario;
        this.cenaValida = "CI";
        this.pecaDoCenario = new Tiles();
    }
    ...
    public void coletarPizzaSeEncostar(Player jogador) {
        for (int lin = 0; lin < this.cenarioValido.length; lin++) {
            for (int col = 0; col < this.cenarioValido[0].length; col++) {

                if (this.cenarioValido[lin][col] == 58) {
                    java.awt.Rectangle areaPizza = new java.awt.Rectangle(
                            col * 48 - 10, lin * 48 - 10, 68, 68);

                    if (jogador.areaColisao.intersects(areaPizza)) {
                        int tileChao;
                        switch (this.cenaValida) {
                            case "C1":
                                tileChao = 17;
                            ...
                            case "C5":
                                ...
                                break;
                            case "C6":
                                tileChao = col >= 5 && col <= 9 ? 56 : 55;
                                break; // água ou chão
                            default:
                                tileChao = 17;
                                break;
                        }
                        this.cenarioValido[lin][col] = tileChao;
                        jogador.adicionarPizza();
                        System.out.println("Pizza coletada!");
                    }
                }
            }
        }
