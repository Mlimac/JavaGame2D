        ...
        for (int col = 0; col < this.cenarioValido[0].length; col++) {
            ...
            if (this.cenarioValido[lin][col] == 58) {
                ...
                if (jogador.areaColisao.intersects(areaPizza)) {
                    int tileChao;
                    switch (this.cenaValida) {
                        case "C1": tileChao = 17; break;
                        case "C2": tileChao = 17; break;
                        case "C3": tileChao = col <= 6 ? 9 : 11; break; // grama ou rua
                        case "C4": tileChao = 45; break;
                        case "C5": tileChao = 54; break;
                        case "C6": tileChao = col >= 5 && col <= 9 ? 56 : 55; break; // água ou chão
                        default:   tileChao = 17; break;
                    }
