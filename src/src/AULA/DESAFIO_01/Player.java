...
public class Player {
	...
	public Player() {
		...
		for (int i = 0; i < 3; i++) {
			this.imgPlayerDown[i] = new ImageIcon("res_cenario/PLAYERS/down" + (i+1) + ".png").getImage();
			this.imgPlayerRight[i] = new ImageIcon("res_cenario/PLAYERS/right" + (i+1) + ".png").getImage();
			this.imgPlayerLeft[i] = new ImageIcon("res_cenario/PLAYERS/left" + (i+1) + ".png").getImage();
			this.imgPlayerUp[i] = new ImageIcon("res_cenario/PLAYERS/up" + (i+1) + ".png").getImage();
		}
